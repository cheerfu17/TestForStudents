...
namespace Test
{
    class Theme1 : MainWin
    {
        ...
        public void Qes1()
        {
            lb.Text = "Какой тип данных используется для создания целочисленных переменных?";
            b1.Text = "int";
            b2.Text = "char";
            b3.Text = "bool";
            b4.Text = "string";
        ...
        public void Qes2()
        {
            lb.Text = "Какой тип данных используется для создания строковой переменной?";
            b1.Text = "char";
            b2.Text = "int";
            b3.Text = "string";
            b4.Text = "double";
        ...
        public void Qes3()
        {
            lb.Text = "Выберите правильный синтаксис инициализации переменной:";
        ...
        public void Qes4()
        {
            lb.Text = "Что представляет из себя переменная с типом string?";
        ...
        public void Qes5()
        {
            lb.Text = "Выберите логический тип данных";
            b1.Text = "int";
            b2.Text = "bool";
            b3.Text = "string";
            b4.Text = "char";
        ...
        public void Qes6()
        {
            lb.Text = "Char это _________ тип данных";
            b1.Text = "Строковый";
            b2.Text = "Числовой";
            b3.Text = "Логический";
            b4.Text = "Символьный";
        ...
        public void Qes7()
        {
            lb.Text = "Для создания переменной с плавающей точкой двойной точности используется тип – ";
            b1.Text = "int";
            b2.Text = "string";
            b3.Text = "double";
            b4.Text = "float";
        ...
        public void Qes8()
        {
            lb.Text = "Для создания переменной с плаающей точкой используется";
            b1.Text = "chat";
            b2.Text = "float";
            b3.Text = "int";
            b4.Text = "long";
        ...
        public void Qes9()
        {
            lb.Text = "Сколько байт памяти выделяется под переменную с типом int?";
            b1.Text = "1";
            b2.Text = "4";
            b3.Text = "2";
            b4.Text = "8";
        ...
        public void Qes10()
        {
            lb.Text = "Какая ошибка допущена в этой строке \"string number = 1; \"?";
