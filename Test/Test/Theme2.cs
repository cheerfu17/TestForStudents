...
namespace Test
{
    class Theme2 : Form1
    {
        ...
        public void Qes2()
        {
            lb.Text = "Выберите верную конструкцию цикла с предусловием";
        ...
        public void Qes3()
        {
            lb.Text = "Что представляет из себя цикл for";
        ...
        public void Qes4()
        {
            lb.Text = "Выберите рузультат выполнения следующй программы int a = 0; for(int i = 0; i < 10; i++) {a = i+2} Console.WriteLine(\"a\");";
            b1.Text = "11";
            b2.Text = "10";
            b3.Text = "9";
            b4.Text = "12";
        ...
        public void Qes5()
        {
            lb.Text = "Выберите верную конструкцию цикла с постусловием";
            b1.Text = "do{}while(условие);";
            b2.Text = "while(условие) {};";
            b3.Text = "for(;;){}";
            b4.Text = "Нет верного ответа";
        ...
        public void Qes6()
        {
            lb.Text = "Выберите верный способ задать бесконечный цикл";
            b1.Text = "while(true) {}";
        ...
        public void Qes7()
        {
            lb.Text = "Для того чтобы принудительно выйти из цикла используется оператор";
            b1.Text = "continue";
            b2.Text = "break";
            b3.Text = "stop";
            b4.Text = "exit";
        ...
        public void Qes8()
        {
            lb.Text = "Для того чтобы принудительно перейти к следующей итерации цикла используется оператор";
            b1.Text = "continue";
            b2.Text = "break";
            b3.Text = "stop";
            b4.Text = "exit";
        ...
        public void Qes9()
        {
            lb.Text = "Цикл для перебора значений во множествах называется";
            b1.Text = "for";
            b2.Text = "while";
            b3.Text = "for each";
            b4.Text = "do-while";
        ...
        public void Qes10()
        {
            lb.Text = "Выберите верную конструкцию совместного цикла";
            b1.Text = "do{}while(условие);";
            b2.Text = "while(условие) {};";
            b3.Text = "for(;;){}";
