...
namespace Test
{
    class Theme4 : MainWin
    {
        ...
        public void Qes1()
        {
            lb.Text = "Выберите оператор сравнения:";
            b1.Text = "?";
            b2.Text = "!=";
            b3.Text = "++";
            b4.Text = "/";
        ...
        public void Qes3()
        {
            lb.Text = "Результат работы фрагмента программы:\nchar a, b, c;\na = 'b'; b = 'c'; c = a;\nConsole.WriteLine({0}{1}{2}{3}, a, b, c, 'c');";
            b1.Text = "abba";
            b2.Text = "abcc";
            b3.Text = "bcbc";
            b4.Text = "bcac";
        ...
        public void Qes4()
        {
            lb.Text = "Выберите оператор присвоения:";
            b1.Text = "==";
            b2.Text = "+";
            b3.Text = "=";
            b4.Text = "!=";
        ...
        public void Qes5()
        {
            lb.Text = "Оператор логического исключения ИЛИ";
            b1.Text = "^";
            b2.Text = "||";
            b3.Text = "&";
            b4.Text = "!";
        ...
        public void Qes6()
        {
            lb.Text = "Значение выражения 13 % 2 / 4 равно:";
            b1.Text = "1";
            b2.Text = "5";
            b3.Text = "0.25";
            b4.Text = "4.5";
        ...
        public void Qes7()
        {
            lb.Text = "Знак плюс в выражении a += 1 является __________ оператором:";
            b1.Text = "Унарным";
            b2.Text = "Бинарным";
            b3.Text = "Тринарным";
        ...
        public void Qes8()
        {
            lb.Text = "Выберите оператор для остановки цикла";
            b1.Text = "stop";
            b2.Text = "pause";
            b3.Text = "break";
            b4.Text = "continue";
        ...
        public void Qes9()
        {
            lb.Text = "Выберите оператор выбора";
            b1.Text = "if";
            b2.Text = "switch";
            b3.Text = "else";
            b4.Text = "=";
        ...
        public void Qes10()
        {
            lb.Text = "Данный оператор ? : является ";
            b1.Text = "унарным";
            b2.Text = "бинарным";
            b3.Text = "тринарным";
            b4.Text = "многозначным";
            //номер правильного ответа
            rightAnswer = 3;
