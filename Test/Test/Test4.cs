...
namespace Test
{
    ...
    public partial class Test4 : Form
    {
        ...
        public Test4(ListBox _lb1, ListBox _lb2, string _filePath)
        {
            lb1 = _lb1;
            lb2 = _lb2;
            filePath = _filePath;
            ...
            Theme4 t = new Theme4(label1, radioButton1, radioButton2, radioButton3, radioButton4, checkBox1, checkBox2, checkBox3, checkBox4, flag, button1);
