...
namespace Test
{
    ...
    public partial class Test3 : Form
    {
        ...
        public Test3(ListBox _lb1, ListBox _lb2, string _filePath)
        {
            lb1 = _lb1;
            lb2 = _lb2;
            filePath = _filePath;
            ...
            Theme3 t = new Theme3(label1, radioButton1, radioButton2, radioButton3, radioButton4, flag, button1);
            eq = t.rightAnswer;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (button1.Text == "Закончить тест")
            {
                ...
                File.AppendAllText(f.filePath, $"В тесте 3 вы набрали {score} баллов\n");
